  ...
  const plans = [
    {
      ...
      features: ['Access to standard chat models', 'Standard image generation', '60 requests per minute', 'Basic community support', '1,000 requests per day'],
      stripeId: 'None',
      status: 'Active',
    },
    {
      ...
      features: ['Access to ALL Flagship models', 'GPT-4o, Claude 3.5, Gemini 1.5 Pro', 'Reasoning & Specialized models', 'High-res image & Video generation', '500 requests per minute', 'Priority email support'],
